          ...
          <Collapsible trigger="¿Qué derechos tengo durante el proceso?">
            <ul className="ageSection">
              <li className="listIcon__rightTreatedAsMinor">
                Tienes derecho a ser <strong>tratado como menor</strong> hasta
                que la Fiscalía diga lo contrario
              </li>
          ...
          <Collapsible trigger="¿Qué va a pasar en la Fiscalía?">
            <section className="ageSection ageSection__attorney">
              <section className="section">
                ...
                <ul>
                  <li>
                    Pide que te acompañe una/un <strong>abogada/o</strong>{" "}
                    alguien de confianza además de tu educador/a. ¡Es tu
                    derecho!
                  </li>
                  <li>
                  ...
                  <li>
                    Revisa bien tus <strong>documentos</strong>. Es importante
                    que conozcas bien cada uno de ellos, cómo los has conseguido
              ...
              <section className="section">
                ...
                <ul>
                  <li>
                    Todo lo que digas allí se recogerá en un <b>acta</b> y
                  ...
                  <li>
                    ...
                    <strong>
                      Tu documentación es suficiente para demostrar que eres
                      menor de edad
                    </strong>
                    .
                  </li>
